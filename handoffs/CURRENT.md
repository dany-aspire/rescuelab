...
Perform P2-001 exactly as specified on branch `phase-2/p2-001` in
`tasks/phase-2/P2-001.md`. Produce the portfolio evidence audit without
changing application code, rewriting existing incident artifacts, or merging
the branch.

When complete, update the branch handoff to `WORK_PROPOSED` with
`Next actor: CHATGPT_WORK` and `Execution surface: none`, commit and push,
report the result in pull request #12, and stop.
